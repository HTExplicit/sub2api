...
const frame=document.querySelector('iframe'),query=new URLSearchParams(location.search),mode=query.get('mode');
...
window.writes=[];window.events=[];window.notifications=[];
                    ...
                    for width in [1200, 390]:
                        for theme in ['light', 'dark']:
                            ...
                            if mode == 'cindy-balance-probe':
                                ...
                                frame.locator('[data-test="cindy-group-split-submit"]').click()
