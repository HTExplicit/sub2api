...
func loadProxyTrust(ctx context.Context, host *extensionv1.Client, raw string) (*ProxyTrust, int64, error) {
...
func prepareProxy(ctx context.Context, host *extensionv1.Client, raw string, explicitTest bool) (*http.Client, *ProxyResult, error) {
