            ...
            >
              ...
              <span class="min-w-0 flex-1">
                ...
                <span class="mt-0.5 block truncate font-mono text-xs text-gray-500 dark:text-dark-300">
                  {{ apiKey.display_key }} · {{ apiKey.status }}
                </span>
              </span>
            </label>
...
import zh from '@/features/cindy/locales/zh'
import en from '@/features/cindy/locales/en'
import BaseDialog from '@/components/common/BaseDialog.vue'
import Icon from '@/components/icons/Icon.vue'
import { adminAPI } from '@/features/cindy/api'
import type { ApiKey } from '@/features/cindy/api'
import type {
...
} from '@/features/cindy/api'
import { useAppStore } from '@/stores/app'
import { useCindyDraft, useCindyAdminScope } from '@/features/cindy/nativeState'
...
const { available } = useCindyAdminScope()
const savedDraft = useCindyDraft('cindy-group-split')
