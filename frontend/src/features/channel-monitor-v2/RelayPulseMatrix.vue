<template>
  <section
    class="card flex min-h-[360px] flex-col overflow-visible !rounded-none !border-0 !p-6 shadow-outline ring-1 ring-gray-900/5 dark:!bg-dark-800 dark:ring-dark-700"
  >
