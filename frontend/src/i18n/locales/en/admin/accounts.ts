export default {accounts: {
  ...
  importResultSelectionFailed: 'Could not load import results. Retry selection without importing again.',
      ...
      contextCapacity: {
        ...
        readonly: 'Read-only provider-managed catalog; overrides are not supported.',
      ...
      batchTest: {
        ...
        autoModel: 'Automatic (default test model per account)',
        automatic: 'Automatic',
      ...
      testOutputLimited: 'Connection succeeded; the reply reached its output limit.',
      usageWindow: {
