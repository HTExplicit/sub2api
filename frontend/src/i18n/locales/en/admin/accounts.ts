export default {
    accounts: {
      ...
      dataImportHint: 'Select a Sub2API v1/v2 export or converted JSON file, preview validation and conflicts, then confirm the write.',
      dataImportWarning: 'Selecting a file only creates a preview and does not write data.',
      ...
      dataImportSuccess: 'Import completed: created {account_created}, updated {account_updated}, skipped {account_skipped}',
      dataImportCompletedWithErrors: 'Import partially completed: created {account_created}, updated {account_updated}, skipped {account_skipped}, account failures {account_failed}, proxy failures {proxy_failed}',
      dataImportPreview: 'Preview Import',
      dataImportPreviewing: 'Previewing...',
      dataImportPreviewNoWrite: 'Preview only validates and matches; it does not write accounts, proxies, folders, or tags.',
      dataImportPreviewSummary: 'Found {accounts} accounts and {proxies} proxies',
      dataImportVersion: 'Sub2API data format v{version}',
      dataImportConfirm: 'Confirm Import',
      dataImportFinalWarning: 'Data is written only after confirmation. Strong identity conflicts are skipped by default; each can update the existing account or create a new one.',
      importStepFile: 'Choose File',
      importStepConfigure: 'Preview & Configure',
      importStepResult: 'Result',
      importWillCreate: 'Create {count}',
      importWillUpdate: 'Update {count}',
      importWillSkip: 'Skip {count}',
      importUniformSettings: 'Uniform Settings',
      importSettingsPriority: 'Priority: per-account override > enabled uniform setting > JSON value > system default.',
      importItemOverrides: 'Per-account Overrides',
      importActionCreate: 'Create New Account',
      importActionUpdate: 'Update Existing Account',
      importActionSkip: 'Skip',
      importStrongConflict: '{count} strong identity conflict(s) found',
      importInvalid: 'Validation Failed',
      importProxyPreview: 'Proxy Preview ({count})',
      importProxyReuse: 'Reuse Existing',
      importProxyCreate: 'Create New',
      importProxyInvalid: 'Invalid Proxy',
      importCreated: 'Created',
      importUpdated: 'Updated',
      importSkipped: 'Skipped',
      importFailed: 'Failed',
      importSessionReady: 'Located and selected {count} accounts written by this import.',
      importSessionFilter: 'This import ({count})',
