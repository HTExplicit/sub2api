      ...
      features: {
        ...
        riskControl: {
          ...
          refusalRecovery: {
            ...
            description: 'Applies only to Codex Responses over HTTP and WebSocket. Turning off the master switch preserves these settings without running failover or reply replacement.',
            enabled: 'Enable refusal recovery',
            enabledHint: 'Master switch for cyber account failover and refusal-keyword replacement. Disabled by default.',
            cyberFailover: 'Cyber account failover',
            cyberFailoverHint: 'Select another account after cyber_policy; return a retryable client error when all accounts are exhausted.',
