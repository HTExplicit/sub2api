export default {accounts: {
  ...
  tickets: {
    stages: { request: '请求', configuration: '配置检查', lifecycle: '任务状态', account_auth: '账号鉴权', proxy_auth: '代理鉴权', proxy_protocol: '代理协议', proxy_dns: '代理DNS', proxy_connect: '代理连接', tls: 'TLS证书', ticket_validation: '历史 STATE 校验', upstream_http: '上游HTTP', upstream_stream: '上游响应流', upstream_policy: '上游策略', persistence: '持久化' },
    title: 'Codex 路由采集与验证', description: '每个账号和模型每周期最多一次采集和一次业务出口复验；有效资格默认跳过。路由记录最多保留120秒并按需续期，此本地上限不代表上游承诺。材料有效、响应完整、模型声明一致分别记录；本项未验证质量，STATE 长度仅作观测。',
    disabled: '路由采集与验证未开启。', force: '重新采集并验证（已有有效路由也执行一次）', ineligible: '不适用：仅 OpenAI OAuth/Setup Token 非影子账号。',
    valid: '路由记录有效，质量未验证', stop: '停止自动续期', start: '采集并验证', limit: '一次最多选择100个账号。', loadFailed: '无法读取账号或路由配置。',
    submitFailed: '操作失败，请查看状态后重试。', next: '下次续期', last: '最近尝试', length: 'STATE 长度（仅观测）', expires: '路由记录到期时间',
    states: { idle: '待手动采集', ready: '路由记录有效，待续期', retry: '等待路由重试', stopped: '自动续期已停止', manual_running: '手动采集验证中', pre_running: '路由续期验证中', post_running: '路由重试中', needs_cookie_verification: '待业务出口验证' }
  },
  ticketProxy: {
    address: '路由采集代理完整地址', protocol: '协议', test: '测试连接', clear: '清除代理并关闭开关', hint: '失焦仅解析格式；测试使用草稿，不保存配置，不发送OAuth凭据或模型请求。完整账密仅管理员可见。',
  ...
  importResultSelectionFailed: '导入结果获取失败，请重试选择；无需重新导入。',
      ...
      contextCapacity: {
        ...
        editHint: '回车或移开焦点确认，Esc 取消；留空恢复自动优先级。保存账号后生效。',
        unavailable: '此模型暂时没有可明确对应的容量信息。',
        context_window: '上下文窗口',
        max_context_window: '最大窗口',
        ...
        clearHint: '留空恢复自动优先级。',
        clear: '清除自定义',
        invalid: '请输入正安全整数 tokens 或十进制 K/M；不能含小数 token，也不会自动舍入。',
        readonly: '供应商专用目录，只读展示，不支持自定义覆盖。',
        exceedsUpstream: '按当前优先级采用的容量高于上游声明。此值仅供客户端规划，不代表上游真实限制已扩大。',
        sources: {
          custom: '自定义',
          official: '官方',
          upstream: '上游',
        ...
        basis: {
          total_context: '上下文总窗口',
          input_limit: '输入窗口规划预算',
          max_context_window: '最大上下文窗口'
        }
      },
      cindyPageTitle: 'Cindy 账号',
      cindyPageDescription: '管理 Cindy OpenAI API Key 账号及额度状态',
      cindyProbe: {
        title: '额度巡检',
      ...
      apiKeyRevealPasswordTitle: '验证密码',
      apiKeyRevealPasswordLabel: '密码',
      apiKeyRevealPasswordConfirm: '开启',
      apiKeyRevealPasswordRequired: '请输入密码',
      apiKeyRevealFailed: '无法开启 API Key 显示',
      ...
      dataImportHint: '选择 Sub2API v1/v2 导出或转换 JSON，并作为后台任务提交。',
      dataImportFile: '数据文件',
      ...
      dataImportLocalSummary: '已准备提交 {accounts} 个账号和 {proxies} 个代理',
      dataImportSubmitJob: '启动导入任务',
      dataImportPreview: '预览导入',
      dataImportPreviewing: '正在生成预览...',
      dataImportPreviewSummary: '新建 {create}，更新 {update}，拒绝 {reject}',
      dataImportPreviewItems: '预览明细',
      dataImportPreviewAction: '动作',
      dataImportTargetGroup: '目标路由分组',
      dataImportTargetGroupHint: '文件包含 Cindy 账号时必须选择目标分组。',
      dataImportTargetGroupPlaceholder: '选择路由分组',
      dataImportPreviewRequired: '提交任务前请先生成导入预览。',
      dataImportStalePreview: '预览已过期或数据发生变化，请重新生成预览。',
      importUniformSettings: '统一设置',
      importProxyStrategy: '整批代理策略',
      importProxyPreserve: '保持文件设置',
      importProxyDirect: '全部直连',
      importProxyExisting: '使用现有代理',
      importProxySelect: '选择“IP管理”中的代理',
      importProxyRequired: '请选择一个仍然存在的代理。',
      importProxySummary: '代理：{value}',
      importNamePrefix: '名称前缀',
      importNameSuffix: '名称后缀',
      importNotesAppend: '追加',
      importNotesReplace: '替换',
      importTagsPlaceholder: '多个标签用逗号分隔',
      viewModeLabel: '账号视图',
      viewModeTable: '表格',
      viewModeCompact: '紧凑',
      viewModeCards: '卡片',
      ...
      folder: '文件夹',
      tags: '标签',
      manageTaxonomy: '管理文件夹和标签',
      managementClassification: '管理分类',
      noFolders: '暂无文件夹',
      facetsLoadFailed: '分类计数暂不可用。',
      dragToReorder: '拖拽调整顺序',
      taxonomyOrderFailed: '保存顺序失败，已恢复原顺序。',
      taxonomyOrderChanged: '分类集合已变化，请刷新后重新排序。',
      ...
      columns: {
        ...
        schedulerScore: '调度权值',
        status: '状态',
        recentCindyProbe: '最近巡检',
        schedulable: '调度',
        todayStats: '今日统计',
        groups: '路由分组',
        classificationRoute: '管理分类 / 请求路由',
        usage: '用量',
        capacityUsage: '容量 / 用量',
        usageWindows: '用量窗口',
        proxy: '代理',
      ...
      testOutputLimited: '连接成功，回复达到输出额度。',
      usageWindow: {
      ...
      bulkTaxonomy: {
        title: '批量分类',
        selectedAction: '分类所选账号',
        filteredAction: '分类当前筛选结果',
        selectedTarget: '已选择 {count} 个账号',
        filteredTarget: '当前筛选结果共 {count} 个账号',
        keepFolder: '文件夹保持不变',
        moveFolder: '移动到指定文件夹',
        clearFolder: '移至未分类',
        selectFolder: '选择文件夹',
        tagsHint: '分别增加或移除标签，其他已有标签保持不变。',
        addTag: '增加',
        removeTag: '移除',
        submit: '应用分类',
        noChanges: '请至少选择一项分类变更。',
        summaryMove: '移动到“{name}”',
        summaryClear: '移至未分类',
        summaryAddTags: '增加 {count} 个标签',
        summaryRemoveTags: '移除 {count} 个标签',
        targetChanged: '筛选结果数量已变化，列表已刷新，请重新检查并确认。',
        success: '已更新 {count} 个账号的分类。'
      },
      ...
      openai: {
        ...
        codexTurnTicket: 'Codex 路由采集与验证',
        codexTurnTicketDesc: '路由材料有效、响应完整和模型声明一致分别表示不同证据。STATE 长度仅作观测，不能证明套餐或模型质量；本项不包含质量验证。仅在开启拦截时，没有有效路由资格的模型才暂停调度。',
        codexTurnTicketMissing: '暂无有效路由资格，仍允许请求',
        codexTurnTicketReady: '路由已验证，剩余 {time}；质量未验证',
        codexTurnTicketPaused: '暂无有效路由资格，该模型已暂停调度',
      ...
      codexContextWindow: 'Codex 上下文 {count}',
      baseContextWindow: '基础上下文 {count}',
      maxOutputTokens: '最大输出 {count}',
      cindyManagedCatalog: 'Cindy 托管模型目录',
      cindyManagedAliases: 'Cindy 托管兼容映射',
      cindyCatalogLoading: '正在读取 Cindy 模型目录...',
      cindyCatalogLoadFailed: 'Cindy 模型目录读取失败',
      cindyModelVerified: '已验证',
      cindyModelPendingVerification: '待验证',
      poolMode: '池模式',
