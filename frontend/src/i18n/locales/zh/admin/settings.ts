    ...
    settings: {
      ...
      features: {
        ...
        riskControl: {
          ...
          refusalRecovery: {
            title: 'OpenAI 拒答恢复',
            description: '仅处理 Codex Responses HTTP 与 WebSocket。总开关关闭时保留以下配置，但不执行换号或回复替换。',
            enabled: '启用拒答恢复',
            enabledHint: '作为总开关控制 cyber 自动换号和拒答关键词替换。默认关闭。',
            cyberFailover: 'cyber 自动换号',
            cyberFailoverHint: '命中 cyber_policy 时改用其他账号；账号耗尽后向客户端返回可重试错误。',
