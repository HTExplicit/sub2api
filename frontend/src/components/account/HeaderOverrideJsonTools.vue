<template>
  <button
    type="button"
    class="rounded-none bg-primary-50 px-3 py-1 text-xs text-primary-700 transition-colors hover:bg-primary-100 dark:bg-primary-900/30 dark:text-primary-400 dark:hover:bg-primary-900/50"
  ...
  <button
    type="button"
    class="rounded-none bg-primary-50 px-3 py-1 text-xs text-primary-700 transition-colors hover:bg-primary-100 disabled:cursor-not-allowed disabled:opacity-50 dark:bg-primary-900/30 dark:text-primary-400 dark:hover:bg-primary-900/50"
  ...
  <div v-if="showImportPanel" ref="importPanelRef" class="w-full space-y-2">
    ...
    <div class="flex gap-2">
      <button
        type="button"
        class="rounded-none bg-primary-600 px-3 py-1 text-xs text-white transition-colors hover:bg-primary-700"
        @click="applyImport"
      >
      ...
      <button
        type="button"
        class="rounded-none bg-gray-100 px-3 py-1 text-xs text-gray-600 transition-colors hover:bg-gray-200 dark:bg-dark-600 dark:text-gray-400 dark:hover:bg-dark-500"
