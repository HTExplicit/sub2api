...
.table-scroll-container {
  @apply flex flex-col overflow-hidden h-full bg-white dark:bg-dark-800 rounded-none border border-gray-200 dark:border-dark-700 shadow-outline;
}
...
.table-scroll-container :deep(thead) {
  @apply bg-gray-50/80 dark:bg-dark-800;
}
