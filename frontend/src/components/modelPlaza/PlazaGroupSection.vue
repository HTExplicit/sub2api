    ...
    <header class="border-b border-gray-100 px-5 py-4 dark:border-dark-700">
      <div class="flex flex-wrap items-center gap-2">
        ...
        <span
          ...
          class="inline-flex items-center gap-1 rounded-none bg-purple-50 px-2 py-0.5 text-xs font-medium text-purple-600 dark:bg-purple-900/20 dark:text-purple-400"
        >
        ...
        <span
          ...
          class="inline-flex items-center rounded-none bg-violet-50 px-2 py-0.5 text-xs font-medium text-violet-600 dark:bg-violet-900/20 dark:text-violet-400"
        >
