  ...
  >
    <form id="refund-form" @submit.prevent="handleSubmit" class="space-y-4">
      ...
      <div
        ...
        class="rounded-none border border-violet-200 bg-violet-50 p-3 dark:border-violet-800 dark:bg-violet-900/20"
      >
      ...
      <!-- Order Info -->
      <div class="rounded-none bg-gray-50 p-3 dark:bg-dark-700">
      ...
      <div>
        ...
        <div v-if="form.deduct_balance && userBalance != null" class="mt-3 grid grid-cols-2 gap-3">
          <div class="rounded-none bg-gray-50 p-3 text-sm dark:bg-dark-700">
        ...
        <div
          ...
          class="mt-2 rounded-none bg-amber-50 p-3 text-sm text-amber-700 dark:bg-amber-900/20 dark:text-amber-300"
        >
        ...
        <div
          ...
          class="mt-2 rounded-none bg-blue-50 p-3 text-sm text-blue-700 dark:bg-blue-900/20 dark:text-blue-300"
        >
      ...
      <div
        v-if="warning"
        class="rounded-none bg-yellow-50 p-3 text-sm text-yellow-700 dark:bg-yellow-900/20 dark:text-yellow-300"
      >
        {{ warning }}
      </div>
      ...
      <div v-if="requireForce" class="flex items-center gap-2">
        <input
          ...
          v-model="form.force"
          type="checkbox"
          class="h-4 w-4 rounded-none border-gray-300 text-red-600 focus:ring-red-500"
        />
    ...
    <template #footer>
      <div class="flex justify-end gap-3">
        ...
        <button
          ...
          class="rounded-none bg-red-600 px-4 py-2 text-sm font-medium text-white hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 disabled:opacity-50 dark:focus:ring-offset-dark-800"
        >
