<template>
  <div class="flex items-start gap-2 rounded-none border p-2"
    ...
    <button type="button" @click="emit('remove')" class="mt-4 rounded-none p-0.5 text-gray-400 hover:text-red-500">
      <Icon name="x" size="sm" />
    </button>
  </div>
</template>
