<template>
  <div class="grid grid-cols-2 gap-4 lg:grid-cols-4">
    <div class="card p-4 flex items-center gap-3">
      <div class="rounded-none bg-blue-100 p-2 dark:bg-blue-900/30 text-blue-600">
    ...
    <div class="card p-4 flex items-center gap-3">
      <div class="rounded-none bg-amber-100 p-2 dark:bg-amber-900/30 text-amber-600"><svg class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m21 7.5-9-5.25L3 7.5m18 0-9 5.25m9-5.25v9l-9 5.25M3 7.5l9 5.25M3 7.5v9l9 5.25m0-9v9" /></svg></div>
      <div>
        ...
        <p class="flex flex-wrap items-center gap-x-1 text-xs text-gray-500">
          ...
          <span class="group relative inline-flex cursor-help items-center gap-0.5" tabindex="0">
            ...
            <span
              class="pointer-events-none absolute left-1/2 top-full z-30 mt-2 hidden w-56 -translate-x-1/2 rounded-none border border-gray-200 bg-white p-3 text-left text-xs text-gray-700 shadow-outline group-hover:block group-focus:block dark:border-dark-600 dark:bg-dark-800 dark:text-dark-200"
            >
    ...
    <div class="card p-4 flex items-center gap-3">
      <div class="rounded-none bg-green-100 p-2 dark:bg-green-900/30 text-green-600">
    ...
    <div class="card p-4 flex items-center gap-3">
      <div class="rounded-none bg-purple-100 p-2 dark:bg-purple-900/30 text-purple-600">
