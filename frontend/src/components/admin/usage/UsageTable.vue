<template>
  <div :class="flat ? '' : 'card overflow-hidden'">
    ...
    >
      ...
      <button
        type="button"
        class="inline-flex items-center gap-1 rounded-none px-2 py-1 text-xs font-medium text-primary-600 transition-colors hover:bg-primary-50 disabled:cursor-not-allowed disabled:opacity-50 dark:text-primary-400 dark:hover:bg-primary-900/30"
      ...
      >
        <template #cell-user="{ row }">
          <div class="text-sm">
            ...
            <span v-if="row.user?.deleted_at" class="ml-1 inline-flex items-center rounded-none px-1 py-px text-[10px] font-medium leading-tight bg-rose-100 text-rose-600 ring-1 ring-inset ring-rose-200 dark:bg-rose-500/20 dark:text-rose-400 dark:ring-rose-500/30">
        ...
        <template #cell-model="{ row }">
          <div class="space-y-0.5 text-xs">
            ...
            >
              ...
              <span
                class="ml-1 inline-flex rounded-none px-1 py-px text-[10px] font-medium ring-1 ring-inset"
        ...
        <template #cell-group="{ row }">
          <span v-if="row.group" class="inline-flex items-center rounded-none px-2 py-0.5 text-xs font-medium bg-indigo-100 text-indigo-800 dark:bg-indigo-900 dark:text-indigo-200">
            {{ row.group.name }}
          </span>
        ...
        <template #cell-stream="{ row }">
          <div class="flex flex-wrap items-center gap-1">
            <span data-testid="request-type-badge" class="inline-flex items-center rounded-none px-2 py-0.5 text-xs font-medium" :class="getRequestTypeBadgeClass(row)">
              {{ getRequestTypeLabel(row) }}
            </span>
            <span
              v-if="row.native_compaction_v2"
              data-testid="native-compaction-badge"
              class="inline-flex items-center rounded-none bg-teal-100 px-2 py-0.5 text-xs font-medium text-teal-800 dark:bg-teal-900 dark:text-teal-200"
            >
        ...
        <template #cell-billing_mode="{ row }">
          <span class="inline-flex items-center rounded-none px-2 py-0.5 text-xs font-medium" :class="getBillingModeBadgeClass(getDisplayBillingMode(row))">
            ...
            <div class="space-y-1 text-sm">
              ...
              <div v-if="row.cache_read_tokens > 0 || row.cache_creation_tokens > 0" class="flex items-center gap-2">
                ...
                <div v-if="row.cache_creation_tokens > 0" class="inline-flex items-center gap-1">
                  ...
                  <span v-if="row.cache_creation_1h_tokens > 0" class="inline-flex items-center rounded-none px-1 py-px text-[10px] font-medium leading-tight bg-orange-100 text-orange-600 ring-1 ring-inset ring-orange-200 dark:bg-orange-500/20 dark:text-orange-400 dark:ring-orange-500/30">1h</span>
                  <span v-if="row.cache_ttl_overridden" :title="t('usage.cacheTtlOverriddenHint')" class="inline-flex items-center rounded-none px-1 py-px text-[10px] font-medium leading-tight bg-rose-100 text-rose-600 ring-1 ring-inset ring-rose-200 dark:bg-rose-500/20 dark:text-rose-400 dark:ring-rose-500/30 cursor-help">R</span>
                </div>
              </div>
          ...
          <div class="text-sm">
            <div class="flex items-center gap-1.5">
              ...
              <span
                ...
                class="inline-flex items-center rounded-none px-1 py-px text-[10px] font-semibold leading-tight bg-amber-100 text-amber-700 ring-1 ring-inset ring-amber-200 dark:bg-amber-500/20 dark:text-amber-300 dark:ring-amber-500/30"
              >x2</span>
              <!-- Cost Detail Tooltip -->
              <div
                class="group relative"
        ...
        <template #cell-request_id="{ row }">
          <div v-if="row.request_id" class="flex max-w-[160px] items-center gap-1.5">
            ...
            <button
              type="button"
              class="shrink-0 rounded-none p-0.5 text-gray-400 transition-colors hover:bg-gray-100 hover:text-gray-600 dark:hover:bg-dark-700 dark:hover:text-gray-300"
  ...
  <Teleport to="body">
    ...
    >
      <div class="whitespace-nowrap rounded-none border border-gray-700 bg-gray-900 px-3 py-2.5 text-xs text-white shadow-outline dark:border-gray-600 dark:bg-gray-800">
          ...
          <div>
              ...
              <template v-if="tokenTooltipData.cache_creation_5m_tokens > 0 || tokenTooltipData.cache_creation_1h_tokens > 0">
                <div v-if="tokenTooltipData.cache_creation_5m_tokens > 0" class="flex items-center justify-between gap-4">
                  <span class="text-gray-400 flex items-center gap-1.5">
                    ...
                    <span class="inline-flex items-center rounded-none px-1 py-px text-[10px] font-medium leading-tight bg-amber-500/20 text-amber-400 ring-1 ring-inset ring-amber-500/30">5m</span>
                  </span>
                ...
                <div v-if="tokenTooltipData.cache_creation_1h_tokens > 0" class="flex items-center justify-between gap-4">
                  <span class="text-gray-400 flex items-center gap-1.5">
                    ...
                    <span class="inline-flex items-center rounded-none px-1 py-px text-[10px] font-medium leading-tight bg-orange-500/20 text-orange-400 ring-1 ring-inset ring-orange-500/30">1h</span>
                  </span>
            ...
            <div v-if="tokenTooltipData && tokenTooltipData.cache_ttl_overridden" class="flex items-center justify-between gap-4">
              <span class="text-gray-400 flex items-center gap-1.5">
                ...
                <span class="inline-flex items-center rounded-none px-1 py-px text-[10px] font-medium leading-tight bg-rose-500/20 text-rose-400 ring-1 ring-inset ring-rose-500/30">R-{{ tokenTooltipData.cache_creation_1h_tokens > 0 ? '5m' : '1H' }}</span>
              </span>
