<template>
  ...
  >
    <div class="space-y-5">
      <div class="rounded-none border border-amber-200 bg-amber-50 p-4 text-sm text-amber-900 dark:border-amber-500/30 dark:bg-amber-500/10 dark:text-amber-100">
      ...
      <div class="grid gap-4 md:grid-cols-[minmax(0,1fr)_240px]">
        <section class="min-h-[320px] max-h-[46vh] overflow-y-auto rounded-none border border-gray-200 bg-white p-5 dark:border-dark-700 dark:bg-dark-900">
      ...
      <div class="space-y-3">
        ...
        <div class="rounded-none bg-gray-100 px-3 py-2 font-mono text-sm text-gray-900 dark:bg-dark-800 dark:text-dark-100">
          {{ expectedPhrase }}
        </div>
        <Input
