<template>
  <div
    class="inline-flex h-9 items-center rounded-none border border-gray-300 bg-white p-0.5 dark:border-dark-600 dark:bg-dark-800"
    role="group"
  ...
  >
    <button
      ...
      :class="modelValue === option.value
        ? 'bg-gray-100 text-primary-700 shadow-outline dark:bg-dark-700 dark:text-primary-300'
