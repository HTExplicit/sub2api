...
.date-picker-trigger {
  ...
  @apply rounded-none px-3 py-2 text-sm;
...
.date-picker-preset {
  @apply rounded-none px-3 py-1.5 text-xs font-medium;
...
.date-picker-input {
  @apply w-full rounded-none px-2 py-1.5 text-sm;
...
.date-picker-apply {
  @apply rounded-none px-4 py-1.5 text-sm font-medium;
