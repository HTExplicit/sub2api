    ...
    <Transition name="popup-fade">
      ...
      >
        ...
        >
          ...
          <div class="relative overflow-hidden border-b border-amber-100/80 bg-amber-50/80 px-8 py-6 dark:border-dark-700 dark:bg-amber-900/20">
            <!-- Decorative background -->
            <div class="absolute right-0 top-0 h-full w-64 bg-orange-100/30 dark:bg-orange-900/20"></div>
            <div class="absolute -right-8 -top-8 h-32 w-32 rounded-full bg-amber-400/20 blur-3xl"></div>
            <div class="absolute -left-4 -bottom-4 h-24 w-24 rounded-full bg-yellow-400/20 blur-2xl"></div>

            <div class="relative z-10">
              <!-- Icon and badge -->
              <div class="mb-3 flex items-center gap-2">
                <div class="flex h-10 w-10 items-center justify-center rounded-none bg-amber-500 text-white shadow-outline">
                  <svg class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9" />
                  </svg>
                </div>
                <span class="inline-flex items-center gap-1.5 rounded-none bg-amber-500 px-2.5 py-1 text-xs font-medium text-white shadow-outline">
          ...
          <div class="max-h-[50vh] overflow-y-auto bg-white px-8 py-8 dark:bg-dark-800">
            <div class="relative">
              <div class="absolute left-0 top-0 bottom-0 w-1 rounded-full bg-amber-500"></div>
              <div class="pl-6">
                <div
          ...
          <div class="border-t border-gray-100 bg-gray-50/50 px-8 py-5 dark:border-dark-700 dark:bg-dark-900">
            <div class="flex items-center justify-end">
              <button
                ...
                class="rounded-none bg-amber-500 px-6 py-2.5 text-sm font-medium text-white shadow-outline transition-all hover:shadow-outline"
              >
