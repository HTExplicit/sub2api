...
<template>
  ...
  >
    ...
    <slot name="trigger">
      <svg
        class="h-4 w-4 cursor-help text-muted transition-colors hover:text-primary-600 dark:hover:text-primary-400"
        fill="none"
        viewBox="0 0 24 24"
        stroke="currentColor"
        stroke-width="2"
    ...
    <Teleport to="body">
      ...
      >
        <button
          ...
          type="button"
          class="absolute right-1.5 top-1.5 rounded-none p-1 text-gray-300 transition-colors hover:bg-white/10 hover:text-white"
          aria-label="Close"
