          ...
          <div class="p-4">
            <div class="flex items-start gap-3">
              ...
              <button
                ...
                class="-m-1 flex-shrink-0 rounded-none p-1 text-muted transition-colors hover:bg-gray-100 hover:text-gray-600 dark:hover:bg-dark-700 dark:hover:text-gray-300"
