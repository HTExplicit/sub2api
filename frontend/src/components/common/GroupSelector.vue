  ...
  <div>
    ...
    <div
      :class="[
        ...
        isSearchable
          ? 'rounded-none border border-t-0 border-gray-200 bg-gray-50 dark:border-dark-600 dark:bg-dark-800'
          : 'rounded-none border border-gray-200 bg-gray-50 dark:border-dark-600 dark:bg-dark-800'
      ]"
    >
      <label
