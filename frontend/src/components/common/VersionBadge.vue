  ...
  <div class="relative">
    ...
    <template v-if="isAdmin">
      <button
        ...
        class="flex items-center gap-1.5 rounded-none px-2 py-1 text-xs transition-colors"
        :class="[
          badgeNeedsAttention
      ...
      >
        ...
        <span
          v-else
          class="h-3 w-12 animate-pulse rounded-none bg-gray-200 font-medium dark:bg-dark-600"
        ></span>
        <!-- Update indicator -->
        ...
        >
          ...
          >
            ...
            <button
              ...
              class="rounded-none p-1.5 text-gray-400 transition-colors hover:bg-gray-100 hover:text-gray-600 dark:hover:bg-dark-700 dark:hover:text-dark-200"
              :disabled="loading"
          ...
          <div class="p-4">
            ...
            <template v-else>
              ...
              <div v-if="updateError" class="space-y-2">
                <div
                  class="flex items-center gap-3 rounded-none border border-red-200 bg-red-50 p-3 dark:border-red-800/50 dark:bg-red-900/20"
                >
                  <div
                ...
                <button
                  @click="handleUpdate"
                  :disabled="updating"
                  class="flex w-full items-center justify-center gap-2 rounded-none bg-red-500 px-4 py-2 text-sm font-medium text-white transition-colors hover:bg-red-600 disabled:cursor-not-allowed disabled:opacity-50"
                >
                  {{ t('version.retry') }}
                </button>
              </div>
              ...
              <div v-else-if="updateSuccess && needRestart" class="space-y-2">
                <div
                  class="flex items-center gap-3 rounded-none border border-green-200 bg-green-50 p-3 dark:border-green-800/50 dark:bg-green-900/20"
                >
                  <div
                ...
                <button
                  @click="handleRestart"
                  :disabled="restarting"
                  class="flex w-full items-center justify-center gap-2 rounded-none bg-green-500 px-4 py-2 text-sm font-medium text-white transition-colors hover:bg-green-600 disabled:cursor-not-allowed disabled:opacity-50"
                >
                  <svg
                    v-if="restarting"
              ...
              <div v-else-if="isDownstream" class="space-y-2">
                <div
                  class="flex items-start gap-3 rounded-none border p-3"
                ...
                >
                  ...
                  <div class="min-w-0 flex-1">
                    ...
                    <div v-if="downstreamStatus" class="mt-2" data-testid="downstream-release-status">
                      <span class="inline-flex rounded-none bg-white px-2 py-0.5 text-[11px] font-medium text-blue-700 dark:bg-dark-800 dark:text-blue-300">
              ...
              <div v-else-if="hasUpdate && !isReleaseBuild" class="space-y-2">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  class="group flex items-center gap-3 rounded-none border border-amber-200 bg-amber-50 p-3 transition-colors hover:bg-amber-100 dark:border-amber-800/50 dark:bg-amber-900/20 dark:hover:bg-amber-900/30"
                >
                  <div
                ...
                <!-- Source build hint -->
                <div
                  class="flex items-center gap-2 rounded-none border border-blue-200 bg-blue-50 p-2 dark:border-blue-800/50 dark:bg-blue-900/20"
                >
                  <svg
              ...
              <div v-else-if="hasUpdate && isReleaseBuild" class="space-y-2">
                <!-- Update info card -->
                <div
                  class="flex items-center gap-3 rounded-none border border-amber-200 bg-amber-50 p-3 dark:border-amber-800/50 dark:bg-amber-900/20"
                >
                <div
                  class="flex h-8 w-8 flex-shrink-0 items-center justify-center rounded-full bg-amber-100 dark:bg-amber-900/50"
                >
                ...
                <button
                  @click="handleUpdate"
                  :disabled="updating"
                  class="flex w-full items-center justify-center gap-2 rounded-none bg-primary-500 px-4 py-2 text-sm font-medium text-white transition-colors hover:bg-primary-600 disabled:cursor-not-allowed disabled:opacity-50"
                >
                  ...
                  <transition name="rollback">
                    <div v-if="rollbackPanelOpen" class="mt-2 space-y-2">
                      ...
                      <div v-else-if="rollbackVersionsError" class="space-y-2">
                        <p
                          class="rounded-none border border-red-200 bg-red-50 p-2.5 text-xs text-red-600 dark:border-red-800/50 dark:bg-red-900/20 dark:text-red-400"
                        >
                          {{ rollbackVersionsError }}
                        </p>
                        <button
                          @click="loadRollbackVersions"
                          class="w-full rounded-none border border-gray-200 py-1.5 text-xs text-gray-500 transition-colors hover:bg-gray-50 hover:text-gray-700 dark:border-dark-700 dark:text-dark-400 dark:hover:bg-dark-700 dark:hover:text-dark-200"
                        >
                          {{ t('version.retry') }}
                        </button>
                      </div>
                      ...
                      <template v-else>
                        ...
                        <button
                          ...
                          class="flex w-full items-center justify-between rounded-none border px-3 py-2 text-left transition-all disabled:cursor-not-allowed disabled:opacity-60"
                          :class="
                            selectedRollbackVersion === item.version
                              ? 'border-amber-300 bg-amber-50 shadow-outline dark:border-amber-700 dark:bg-amber-900/20'
                              : 'border-gray-200 hover:border-gray-300 hover:bg-gray-50 dark:border-dark-700 dark:hover:border-dark-600 dark:hover:bg-dark-700'
                          "
                        >
                        ...
                        <transition name="rollback">
                          <div v-if="selectedRollbackVersion" class="space-y-2">
                            ...
                            >
                              ...
                              >
                                <div
                                  class="flex items-center gap-0.5 rounded-none bg-gray-200/70 p-0.5 dark:bg-dark-600"
                                >
                                  <button
                            ...
                            <p
                              v-if="rollbackError"
                              class="rounded-none border border-red-200 bg-red-50 p-2 text-xs text-red-600 dark:border-red-800/50 dark:bg-red-900/20 dark:text-red-400"
                            >
                              {{ rollbackError }}
                            </p>
