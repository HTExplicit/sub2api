  ...
  <div class="card">
    ...
    <div class="p-6">
      ...
      <div v-else class="space-y-3">
        <div v-for="log in data" :key="log.id" class="flex items-center justify-between rounded-none bg-gray-50 p-4 transition-colors hover:bg-gray-100 dark:bg-dark-800 dark:hover:bg-dark-700">
          <div class="flex items-center gap-4">
            <div class="flex h-10 w-10 items-center justify-center rounded-none bg-primary-100 dark:bg-primary-900/30">
