              ...
              <div class="space-y-1">
                ...
                >
                  <span
                    ...
                    :key="hint.key"
                    class="inline-flex items-center gap-1 rounded-none bg-white px-3 py-1 ring-1 ring-primary-100 dark:bg-dark-900 dark:ring-primary-900/40"
                  >
    ...
    <div class="space-y-6">
      <div data-testid="profile-main-column" class="space-y-6">
        <section
          ...
          class="card border border-gray-100 bg-white p-6 dark:border-dark-700 dark:bg-dark-900"
        >
          ...
          <div class="grid gap-6 sm:grid-cols-1 md:grid-cols-2">
            <div class="rounded-none border border-gray-100 bg-gray-50/80 p-5 dark:border-dark-700 dark:bg-dark-900">
              <ProfileAvatarCard
                :user="user"
                embedded
              />
