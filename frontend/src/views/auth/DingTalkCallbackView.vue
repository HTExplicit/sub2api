      ...
      <transition name="fade">
        ...
        >
          <div
            ...
            class="rounded-none border border-gray-200 bg-gray-50 p-4 dark:border-dark-600 dark:bg-dark-800"
          >
            <div class="space-y-3">
              <div class="space-y-1">
              ...
              <label
                ...
                class="flex items-start gap-3 rounded-none border border-gray-200 bg-white p-3 text-sm dark:border-dark-600 dark:bg-dark-900"
              >
          ...
          <template v-else-if="needsChooser">
            <div class="rounded-none border border-gray-200 bg-gray-50 p-4 dark:border-dark-600 dark:bg-dark-800">
              <div class="space-y-4">
                <div class="space-y-1">
                  <p class="text-sm font-medium text-gray-900 dark:text-white">
