  ...
  <div ref="containerRef" class="relative">
    <div v-if="selectedUserIds.length > 0" class="mb-2 flex flex-wrap gap-2">
      <span
        ...
        :key="userId"
        class="inline-flex max-w-full items-center gap-1.5 rounded-none bg-gray-100 px-2.5 py-1.5 text-xs text-gray-700 dark:bg-dark-600 dark:text-gray-200"
      >
        ...
        <button
          type="button"
          class="shrink-0 rounded-none text-gray-400 hover:text-red-600 dark:hover:text-red-400"
