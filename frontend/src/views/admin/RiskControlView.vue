      ...
      <template v-else>
            ...
            <div class="flex min-w-0 items-center gap-3">
              ...
              <div class="min-w-0 flex-1">
                <div class="flex min-w-0 items-center justify-between gap-2">
                  ...
                  <span
                    v-if="item.badge"
                    class="inline-flex flex-shrink-0 items-center rounded-none px-2 py-0.5 text-xs font-medium"
        ...
        >
          <div data-test="pre-block-sync-card" class="card">
            <div class="flex flex-col gap-4 border-b border-gray-100 px-6 py-4 dark:border-dark-700 lg:flex-row lg:items-center lg:justify-between">
              ...
              <span class="inline-flex w-fit items-center rounded-none bg-gray-100 px-2.5 py-1 text-xs font-medium text-gray-600 dark:bg-dark-700 dark:text-gray-300">
        ...
        <div v-if="showWorkerRuntimeCard" class="card">
          ...
          <div class="grid grid-cols-1 gap-6 p-6 xl:grid-cols-[minmax(0,360px)_1fr]">
            <div class="space-y-4">
              <div class="rounded-none border border-gray-100 p-4 dark:border-dark-700">
              ...
              <div class="grid grid-cols-2 gap-3">
                <div class="rounded-none bg-gray-50 p-4 dark:bg-dark-700">
                ...
                <div class="rounded-none bg-emerald-50 p-4 dark:bg-emerald-900/10">
            ...
            <div>
              <div class="mb-3 flex items-center justify-between gap-3">
                ...
                <span class="inline-flex items-center rounded-none bg-gray-100 px-2.5 py-1 text-xs font-medium text-gray-600 dark:bg-dark-700 dark:text-gray-300">
                  {{ modeLabel(status?.mode ?? configForm.mode) }}
                </span>
              </div>
              <div class="grid grid-cols-2 gap-2 sm:grid-cols-4 md:grid-cols-6 xl:grid-cols-8 2xl:grid-cols-10">
                <div
                  ...
                  :key="worker.id"
                  class="flex h-12 items-center justify-between rounded-none border px-3 transition-colors"
        ...
        <div class="card">
          <div class="flex flex-col gap-4 border-b border-gray-100 px-6 py-4 dark:border-dark-700">
            ...
            <div class="flex flex-col gap-2 rounded-none border border-gray-100 bg-gray-50 px-3 py-2 dark:border-dark-700 dark:bg-dark-900 sm:flex-row sm:items-center sm:justify-between">
              ...
              <div v-if="modelFilterPreviewModels.length > 0" class="flex flex-wrap gap-1.5">
                <span
                  ...
                  :key="model"
                  class="inline-flex max-w-[180px] items-center truncate rounded-none bg-white px-2 py-1 font-mono text-xs text-gray-600 shadow-outline dark:bg-dark-800 dark:text-gray-300"
                >
                  {{ model }}
                </span>
                <span v-if="hiddenModelFilterModelCount > 0" class="inline-flex rounded-none bg-white px-2 py-1 text-xs text-gray-500 shadow-outline dark:bg-dark-800 dark:text-gray-400">
          ...
          <div class="overflow-x-auto">
            <table class="min-w-full divide-y divide-gray-200 dark:divide-dark-700">
              ...
              <tbody class="divide-y divide-gray-100 bg-white dark:divide-dark-800 dark:bg-dark-800">
                ...
                <template v-else>
                  <tr v-for="row in logs" :key="row.id" class="hover:bg-gray-50 dark:hover:bg-dark-700">
                    ...
                    <td class="whitespace-nowrap px-5 py-4">
                      <span class="inline-flex rounded-none px-2 py-1 text-xs font-medium" :class="resultBadgeClass(row)">
                        {{ resultLabel(row) }}
                      </span>
                    </td>
                    <td class="whitespace-nowrap px-5 py-4 text-sm text-gray-700 dark:text-gray-300">
                    ...
                    <td class="whitespace-nowrap px-5 py-4 text-sm text-gray-700 dark:text-gray-300">
                      ...
                      <button
                        ...
                        type="button"
                        class="mt-2 inline-flex items-center gap-1 rounded-none border border-emerald-200 bg-emerald-50 px-2 py-1 text-xs font-medium text-emerald-700 transition-colors hover:bg-emerald-100 disabled:cursor-not-allowed disabled:opacity-60 dark:border-emerald-900/60 dark:bg-emerald-900/20 dark:text-emerald-300 dark:hover:bg-emerald-900/30"
                    ...
                    <td class="w-[320px] max-w-sm px-5 py-4 text-sm text-gray-700 dark:text-gray-300">
                      <button
                        type="button"
                        class="group flex w-full min-w-0 items-center gap-2 rounded-none px-2 py-1.5 text-left transition-colors hover:bg-gray-100 dark:hover:bg-dark-700"
        ...
        <div class="space-y-6">
          <div class="flex gap-2 overflow-x-auto border-b border-gray-100 pb-3 dark:border-dark-700">
            <button
              ...
              :key="tab.id"
              type="button"
              class="inline-flex whitespace-nowrap rounded-none px-3 py-2 text-sm font-medium transition-colors"
          ...
          <div v-if="activeSettingsTab === 'basic'" class="space-y-5">
            <div class="grid grid-cols-1 gap-5 lg:grid-cols-2">
              <div class="flex items-center justify-between rounded-none border border-gray-100 p-4 dark:border-dark-700">
                <div>
            ...
            <div class="overflow-hidden rounded-none border border-gray-100 bg-white shadow-outline dark:border-dark-700 dark:bg-dark-800">
              ...
              <div class="grid grid-cols-1 gap-4 p-4 xl:grid-cols-[minmax(0,1fr)_minmax(360px,440px)]">
                <div class="space-y-3">
                  <div class="flex flex-col gap-2 rounded-none border border-gray-100 bg-gray-50 p-2 dark:border-dark-700 dark:bg-dark-900 sm:flex-row sm:items-center sm:justify-between">
                    ...
                    <div class="inline-flex rounded-none bg-white p-1 shadow-outline dark:bg-dark-800">
                      <button
                        type="button"
                        class="rounded-none px-3 py-1.5 text-xs font-medium transition-colors"
                        :class="configForm.api_keys_mode === 'append' ? 'bg-primary-500 text-white shadow-outline' : 'text-gray-600 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-dark-700'"
                      ...
                      <button
                        type="button"
                        class="rounded-none px-3 py-1.5 text-xs font-medium transition-colors"
                        :class="configForm.api_keys_mode === 'replace' ? 'bg-amber-500 text-white shadow-outline' : 'text-gray-600 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-dark-700'"
                        :disabled="configForm.clear_api_key"
                  ...
                  <div class="flex flex-wrap items-center gap-2 text-xs text-gray-500 dark:text-gray-400">
                    <span class="inline-flex rounded-none bg-gray-100 px-2 py-1 dark:bg-dark-700">
                      {{ t('admin.riskControl.inputApiKeyCount', { count: inputApiKeyCount }) }}
                    </span>
                    <span v-if="configForm.api_key_configured" class="inline-flex rounded-none bg-gray-100 px-2 py-1 dark:bg-dark-700">
                      {{ t('admin.riskControl.storedApiKeyCount', { count: configForm.api_key_count }) }}
                    </span>
                    <span v-if="configForm.clear_api_key" class="inline-flex rounded-none bg-red-50 px-2 py-1 text-red-700 dark:bg-red-900/20 dark:text-red-300">
                      {{ t('admin.riskControl.apiKeyWillClear') }}
                    </span>
                    <span v-else-if="pendingDeletedApiKeyCount > 0" class="inline-flex rounded-none bg-amber-50 px-2 py-1 text-amber-700 dark:bg-amber-900/20 dark:text-amber-300">
                      {{ t('admin.riskControl.apiKeyPendingDeleteCount', { count: pendingDeletedApiKeyCount }) }}
                    </span>
                    <span v-if="configForm.api_keys_mode === 'replace'" class="inline-flex rounded-none bg-amber-50 px-2 py-1 text-amber-700 dark:bg-amber-900/20 dark:text-amber-300">
                      {{ t('admin.riskControl.apiKeysReplaceWarning') }}
                    </span>
                  </div>

                  <div class="rounded-none border border-gray-100 bg-gray-50 p-3 dark:border-dark-700 dark:bg-dark-900" @paste="handleModerationImagePaste">
                    <div class="mb-3 flex items-center justify-between gap-3">
                      <div>
                      ...
                      <button
                        ...
                        type="button"
                        class="inline-flex items-center gap-1 rounded-none px-2 py-1 text-xs font-medium text-gray-500 hover:bg-white hover:text-gray-900 dark:text-gray-400 dark:hover:bg-dark-800 dark:hover:text-white"
                    ...
                    ></textarea>
                    <div
                      class="mt-3 rounded-none border border-dashed border-gray-200 bg-white p-3 dark:border-dark-700 dark:bg-dark-800"
                      @dragover.prevent
                    ...
                    >
                      ...
                      <div v-if="moderationTestImages.length > 0" class="mt-3 grid grid-cols-2 gap-2 sm:grid-cols-4">
                        <div
                          ...
                          class="group relative aspect-square overflow-hidden rounded-none border border-gray-100 bg-gray-100 dark:border-dark-700 dark:bg-dark-700"
                        >
                ...
                <div class="rounded-none border border-gray-100 bg-gray-50 p-3 dark:border-dark-700 dark:bg-dark-900">
                  <div class="mb-3 flex items-start justify-between gap-3">
                    ...
                    <span class="inline-flex shrink-0 items-center whitespace-nowrap rounded-none bg-white px-2 py-0.5 text-[11px] font-medium leading-5 text-gray-600 shadow-outline dark:bg-dark-800 dark:text-gray-300">
                      {{ t('admin.riskControl.apiKeyRows', { count: apiKeyRows.length }) }}
                    </span>
                  </div>

                  <div v-if="apiKeyRows.length === 0" class="flex min-h-32 flex-col items-center justify-center rounded-none border border-dashed border-gray-200 bg-white px-4 py-6 text-center dark:border-dark-700 dark:bg-dark-800">
                  ...
                  <div v-else class="space-y-2">
                    <div class="space-y-2" :class="apiKeyRowsExpanded ? 'max-h-72 overflow-y-auto pr-1' : ''">
                      ...
                      >
                        <div class="flex items-start justify-between gap-2">
                          <div class="min-w-0">
                            <div class="flex min-w-0 flex-wrap items-center gap-2">
                              ...
                              <span
                                class="inline-flex rounded-none px-1.5 py-0.5 text-[11px] font-medium"
                          ...
                          <div class="flex flex-shrink-0 items-center gap-1.5">
                            <span class="inline-flex items-center gap-1.5 whitespace-nowrap rounded-none px-2 py-0.5 text-xs font-medium" :class="apiKeyStatusBadgeClass(row.status)">
                            ...
                            <button
                              ...
                              type="button"
                              class="inline-flex h-7 w-7 items-center justify-center rounded-none text-gray-400 transition-colors hover:bg-gray-100 hover:text-gray-700 dark:hover:bg-dark-700 dark:hover:text-gray-200"
                        ...
                        <p v-if="row.last_error" class="mt-1.5 rounded-none bg-amber-50 px-2 py-1.5 text-xs leading-5 text-amber-700 dark:bg-amber-900/20 dark:text-amber-300">
                          {{ row.last_error }}
                        </p>
                      </div>
                    </div>

                    <div v-if="canToggleApiKeyRows" class="flex items-center justify-between gap-3 rounded-none border border-dashed border-gray-200 bg-white px-3 py-2 text-xs text-gray-500 dark:border-dark-700 dark:bg-dark-800 dark:text-gray-400">
                      ...
                      <button
                        type="button"
                        class="inline-flex shrink-0 items-center gap-1 rounded-none px-2 py-1 font-medium text-primary-600 transition-colors hover:bg-primary-50 hover:text-primary-700 dark:text-primary-300 dark:hover:bg-primary-900/20"
                  ...
                  <div v-if="moderationTestResult" class="mt-4 rounded-none border border-gray-100 bg-white p-3 dark:border-dark-700 dark:bg-dark-800">
                    <div class="flex items-start justify-between gap-3">
                      ...
                      <span class="inline-flex rounded-none px-2 py-1 text-xs font-medium" :class="moderationTestResult.flagged ? 'bg-red-50 text-red-700 dark:bg-red-900/20 dark:text-red-300' : 'bg-emerald-50 text-emerald-700 dark:bg-emerald-900/20 dark:text-emerald-300'">
          ...
          <div v-else-if="activeSettingsTab === 'scope'" class="space-y-5">
            <div class="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
              ...
              <div class="inline-flex rounded-none bg-gray-100 p-1 dark:bg-dark-700">
                <button
                  type="button"
                  class="rounded-none px-3 py-1.5 text-sm font-medium transition-colors"
                  :class="configForm.all_groups ? 'bg-white text-gray-900 shadow-outline dark:bg-dark-800 dark:text-white' : 'text-gray-500 dark:text-gray-400'"
            ...
            <div v-if="!configForm.all_groups" class="space-y-4">
              ...
              <div class="grid max-h-[420px] grid-cols-1 gap-3 overflow-y-auto pr-1 md:grid-cols-2 xl:grid-cols-3">
                <button
                  ...
                  :key="group.id"
                  type="button"
                  class="flex min-h-20 items-center justify-between rounded-none border p-4 text-left transition-colors"
                  :class="isGroupSelected(group.id) ? 'border-primary-300 bg-primary-50 dark:border-primary-700 dark:bg-primary-900/20' : 'border-gray-100 hover:bg-gray-50 dark:border-dark-700 dark:hover:bg-dark-700'"
            ...
            <div class="space-y-4 rounded-none border border-gray-100 p-4 dark:border-dark-700">
              <div class="flex flex-col gap-2 lg:flex-row lg:items-center lg:justify-between">
                ...
                <span class="inline-flex w-fit rounded-none bg-gray-100 px-2.5 py-1 text-xs font-medium text-gray-600 dark:bg-dark-700 dark:text-gray-300">
                  {{ modelFilterSummary }}
                </span>
              </div>
              ...
              <div class="grid grid-cols-1 gap-2 md:grid-cols-3">
                <button
                  ...
                  :key="option.value"
                  type="button"
                  class="rounded-none border p-3 text-left transition-colors"
                  :class="configForm.model_filter_type === option.value
                    ? 'border-primary-300 bg-primary-50 text-primary-900 shadow-outline dark:border-primary-700 dark:bg-primary-900/20 dark:text-primary-100'
                    : 'border-gray-100 hover:bg-gray-50 dark:border-dark-700 dark:hover:bg-dark-700'"
          ...
          <div v-else-if="activeSettingsTab === 'runtime'" class="grid grid-cols-1 gap-5 lg:grid-cols-2">
            ...
            <div class="flex items-center justify-between rounded-none border border-gray-100 p-4 dark:border-dark-700 lg:col-span-2">
              <div>
            ...
            <div class="space-y-4 rounded-none border border-gray-100 p-4 dark:border-dark-700 lg:col-span-2">
              ...
              <div class="rounded-none bg-gray-50 p-3 dark:bg-dark-900">
          ...
          <div v-else-if="activeSettingsTab === 'riskThresholds'" class="space-y-5">
            ...
            <div class="grid grid-cols-1 gap-3 md:grid-cols-2 xl:grid-cols-3">
              <div
                ...
                :key="row.category"
                class="rounded-none border border-gray-100 bg-gray-50 p-4 dark:border-dark-700 dark:bg-dark-900"
              >
                <div class="flex items-start justify-between gap-3">
                  <div class="min-w-0">
                  ...
                  <span class="inline-flex shrink-0 rounded-none bg-white px-2 py-1 font-mono text-xs font-medium text-gray-600 shadow-outline dark:bg-dark-800 dark:text-gray-300">
          ...
          <div v-else-if="activeSettingsTab === 'keywords'" class="space-y-5">
            <div
              class="flex items-start gap-3 rounded-none border p-4"
            ...
            <div>
              <div class="mb-2 flex items-center justify-between">
                ...
                <span class="inline-flex rounded-none bg-gray-100 px-2 py-1 text-xs text-gray-500 dark:bg-dark-700 dark:text-gray-300">
          ...
          <div v-else class="grid grid-cols-1 gap-5 lg:grid-cols-2">
            ...
            <div class="rounded-none border border-gray-100 p-4 text-sm text-gray-500 dark:border-dark-700 dark:text-gray-400 lg:col-span-2">
      ...
      >
        <div v-if="inputDetailRow" class="space-y-5">
          <div class="grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-4">
            <div class="rounded-none border border-gray-100 bg-gray-50 p-4 dark:border-dark-700 dark:bg-dark-800">
            ...
            <div class="rounded-none border border-gray-100 bg-gray-50 p-4 dark:border-dark-700 dark:bg-dark-800">
              ...
              <span class="mt-1 inline-flex rounded-none px-2 py-1 text-xs font-medium" :class="resultBadgeClass(inputDetailRow)">
            ...
            <div v-if="inputDetailRow.matched_keyword" class="rounded-none border border-red-100 bg-red-50 p-4 dark:border-red-900/60 dark:bg-red-900/20">
          ...
          <div class="rounded-none border border-gray-100 bg-white p-4 shadow-outline dark:border-dark-700 dark:bg-dark-800">
            <div class="flex flex-wrap items-center justify-between gap-3">
              ...
              <span v-if="inputDetailRow.group_name" class="inline-flex rounded-none bg-sky-50 px-2.5 py-1 text-xs font-medium text-sky-700 dark:bg-sky-900/20 dark:text-sky-300">
                {{ inputDetailRow.group_name }}
              </span>
            </div>
            <pre class="mt-4 max-h-[420px] overflow-auto whitespace-pre-wrap break-words rounded-none bg-gray-950 p-4 text-sm leading-6 text-gray-100 dark:bg-black/50">{{ inputDetailText }}</pre>
          </div>
        </div>
...
const preBlockMetricItems = computed(() => [
  ...
  },
  {
    ...
    class: 'bg-gray-50 dark:bg-dark-700',
