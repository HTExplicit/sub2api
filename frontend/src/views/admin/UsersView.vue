  ...
  <AppLayout>
            ...
            <div v-if="allGroups.length > 0" class="flex flex-col gap-1">
              ...
              >
                ...
                <div
                  ...
                  class="pointer-events-none absolute left-0 top-full z-50 mt-1.5 rounded-none bg-gray-900 px-2.5 py-1.5 text-xs text-white opacity-0 transition-opacity duration-75 group-hover/ex:opacity-100 dark:bg-dark-600"
                >
              ...
              >
                ...
                <!-- Tooltip: 向下弹出 -->
                <div class="pointer-events-none absolute left-0 top-full z-50 mt-1.5 rounded-none bg-gray-900 px-2.5 py-1.5 text-xs text-white opacity-0 transition-opacity duration-75 group-hover/pub:opacity-100 dark:bg-dark-600">
                  <div class="absolute left-4 bottom-full border-4 border-transparent border-b-gray-900 dark:border-b-dark-600"></div>
                  <div class="flex flex-col gap-0.5 whitespace-nowrap">
          ...
          <template #cell-balance="{ value, row }">
            <div class="flex items-center gap-2">
              <div class="group relative">
                ...
                <!-- Instant tooltip -->
                <div class="pointer-events-none absolute bottom-full left-1/2 z-50 mb-1.5 -translate-x-1/2 whitespace-nowrap rounded-none bg-gray-900 px-2 py-1 text-xs text-white opacity-0 transition-opacity duration-75 group-hover:opacity-100 dark:bg-dark-600">
              ...
              <button
                ...
                class="rounded-none px-2 py-0.5 text-xs font-medium text-emerald-600 transition-colors hover:bg-emerald-50 dark:text-emerald-400 dark:hover:bg-emerald-900/20"
          ...
          <template #cell-actions="{ row }">
            <div class="flex items-center gap-1">
              ...
              <button
                ...
                :class="[
                  'flex flex-col items-center gap-0.5 rounded-none p-1.5 text-gray-500 transition-colors',
                  row.status === 'active'
              ...
              <button
                ...
                class="action-menu-trigger flex flex-col items-center gap-0.5 rounded-none p-1.5 text-gray-500 transition-colors hover:bg-gray-100 hover:text-gray-900 dark:hover:bg-dark-700 dark:hover:text-white"
    ...
    <Teleport to="body">
      <div
        ...
        class="action-menu-content fixed z-[9999] w-48 overflow-hidden rounded-none bg-white shadow-outline ring-1 ring-black/5 dark:bg-dark-800 dark:ring-white/10"
