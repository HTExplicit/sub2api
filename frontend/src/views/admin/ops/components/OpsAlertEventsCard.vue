...
<template>
  <div class="rounded-none bg-white p-6 shadow-outline ring-1 ring-gray-900/5 dark:bg-dark-800 dark:ring-dark-700">
    ...
    <div v-else-if="empty" class="rounded-none border border-dashed border-gray-200 p-8 text-center text-sm text-gray-500 dark:border-dark-700 dark:text-gray-400">
      {{ t('admin.ops.alertEvents.empty') }}
    </div>

    <div v-else class="overflow-hidden rounded-none border border-gray-200 dark:border-dark-700">
      <div class="max-h-[600px] overflow-y-auto" @scroll="onScroll">
        <div v-if="!isDesktopViewport" class="divide-y divide-gray-100 dark:divide-dark-800">
          ...
          >
            <div class="flex flex-wrap items-center gap-2">
              <span class="rounded-none px-2 py-1 text-[10px] font-bold" :class="severityBadgeClass(String(row.severity || ''))">
                {{ row.severity || '-' }}
              </span>
              <span class="inline-flex items-center rounded-none px-2 py-1 text-[10px] font-bold ring-1 ring-inset" :class="statusBadgeClass(row.status)">
    ...
    >
      ...
      <div v-else class="space-y-5">
        <div class="rounded-none bg-gray-50 p-4 dark:bg-dark-900">
          <div class="flex flex-col gap-2 sm:flex-row sm:items-start sm:justify-between">
            <div>
              <div class="flex flex-wrap items-center gap-2">
                <span class="inline-flex items-center rounded-none px-2 py-1 text-[10px] font-bold" :class="severityBadgeClass(String(selected.severity || ''))">
                  {{ selected.severity || '-' }}
                </span>
                <span class="inline-flex items-center rounded-none px-2 py-1 text-[10px] font-bold ring-1 ring-inset" :class="statusBadgeClass(selected.status)">
            ...
            <div class="flex flex-wrap gap-2">
              <div class="flex items-center gap-2 rounded-none bg-white px-2 py-1 ring-1 ring-gray-200 dark:bg-dark-800 dark:ring-dark-700">
          ...
          <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
            ...
            <div class="rounded-none bg-gray-50 p-4 dark:bg-dark-900">
              ...
              <div class="mt-1 flex flex-wrap items-center gap-2">
                ...
                <a
                  class="inline-flex items-center gap-1 rounded-none bg-white px-2 py-1 text-[11px] font-bold text-gray-700 ring-1 ring-gray-200 hover:bg-gray-50 dark:bg-dark-800 dark:text-gray-200 dark:ring-dark-700 dark:hover:bg-dark-700"
        ...
        <div class="rounded-none border border-gray-200 bg-white p-4 dark:border-dark-700 dark:bg-dark-800">
          ...
          <div v-else class="overflow-hidden rounded-none border border-gray-100 dark:border-dark-700">
              ...
              <tbody class="divide-y divide-gray-100 dark:divide-dark-700">
                <tr v-for="it in history" :key="it.id" class="hover:bg-gray-50 dark:hover:bg-dark-700">
                  ...
                  <td class="px-3 py-2 text-xs">
                    <span class="inline-flex items-center rounded-none px-2 py-1 text-[10px] font-bold ring-1 ring-inset" :class="statusBadgeClass(it.status)">
