      ...
      <template #table>
        ...
        >
          ...
          <template #cell-group_count="{ row }">
            <span
              class="inline-flex items-center rounded-none bg-gray-100 px-2 py-0.5 text-xs font-medium text-gray-800 dark:bg-dark-600 dark:text-gray-300"
            >
        ...
        <form id="channel-form" @submit.prevent="handleSubmit" class="flex-1 overflow-y-auto pt-4">
            ...
            <div class="space-y-3">
              ...
              <div class="flex flex-wrap gap-2">
                <label
                  ...
                  :key="p"
                  class="inline-flex cursor-pointer items-center gap-1.5 rounded-none border px-3 py-1.5 text-sm transition-colors"
          ...
          >
            ...
            <div>
              ...
              <div class="max-h-40 overflow-auto rounded-none border border-gray-200 bg-gray-50 p-2 dark:border-dark-600 dark:bg-dark-900">
                ...
                <div v-else class="flex flex-wrap gap-1">
                  <label
                    ...
                    :key="group.id"
                    class="inline-flex cursor-pointer items-center gap-1.5 rounded-none border border-gray-200 px-2 py-1 text-xs transition-colors hover:bg-gray-50 dark:border-dark-600 dark:hover:bg-dark-700"
                    :class="[
                  ...
                  >
                    <input
                      ...
                      class="h-3 w-3 rounded-none border-gray-300 text-primary-600 focus:ring-primary-500"
                      @change="toggleGroupInSection(sIdx, group.id)"
                    />
                    <span :class="['font-medium', platformTextClass(group.platform)]">{{ group.name }}</span>
                    <span
                      :class="['rounded-none px-1 py-0 text-[10px]', platformBadgeLightClass(group.platform)]"
            ...
            <div>
              ...
              <div
                ...
                class="rounded-none border border-dashed border-gray-300 p-2 text-center text-xs text-gray-400 dark:border-dark-500"
              >
              ...
              <div v-else class="space-y-1">
                ...
                >
                  ...
                  <button
                    ...
                    class="rounded-none p-0.5 text-gray-400 hover:text-red-500"
                  >
                    <Icon name="trash" size="sm" />
                  </button>
                </div>
            ...
            <div class="mt-4 border-t border-gray-200 pt-4 dark:border-dark-700 space-y-3">
              <div class="flex items-center justify-between">
                ...
                <button
                  ...
                  class="rounded-none border border-primary-300 px-3 py-1 text-xs font-medium text-primary-600 hover:bg-primary-50 dark:border-primary-600 dark:text-primary-400 dark:hover:bg-primary-900/20"
                >
              ...
              <div
                ...
                :key="ruleIndex"
                class="space-y-3 rounded-none border border-gray-200 p-4 dark:border-dark-600"
              >
                <div class="flex items-center justify-between">
                  <input
                    v-model="rule.name"
                ...
                <div>
                  ...
                  <div class="mt-1 flex flex-wrap gap-1">
                    <label
                      ...
                      :key="gid"
                      class="inline-flex cursor-pointer items-center gap-1 rounded-none border px-2 py-1 text-xs transition-colors"
                      :class="rule.group_ids.includes(gid)
                        ? 'border-primary-300 bg-primary-50 dark:border-primary-700 dark:bg-primary-900/20'
                        : 'border-gray-200 hover:bg-gray-50 dark:border-dark-600 dark:hover:bg-dark-700'"
                    >
                      <input type="checkbox" :checked="rule.group_ids.includes(gid)" class="h-3 w-3 rounded-none border-gray-300 text-primary-600 focus:ring-primary-500" @change="rule.group_ids.includes(gid) ? rule.group_ids.splice(rule.group_ids.indexOf(gid), 1) : rule.group_ids.push(gid)" />
                ...
                <div>
                  ...
                  <div class="mt-1 flex flex-wrap gap-1">
                    <span
                      ...
                      :key="accountId"
                      class="inline-flex items-center gap-1 rounded-none border border-primary-300 bg-primary-50 px-2 py-0.5 text-xs dark:border-primary-700 dark:bg-primary-900/20"
                    >
                ...
                <div>
                  ...
                  <div v-if="rule.pricing.length === 0" class="rounded-none border border-dashed border-gray-300 p-2 text-center text-xs text-gray-400 dark:border-dark-500">
...
// ── Platform config ──
const platformOrder: GroupPlatform[] = ['anthropic', 'openai', 'gemini', 'antigravity', 'grok', 'kimi', 'zhipu', 'deepseek', 'minimax', 'cindy', 'opencode_go']
// Composite pricing/mapping may target every concrete schedulable provider.
const compositePlatforms: GroupPlatform[] = ['anthropic', 'openai', 'gemini', 'antigravity', 'grok', 'kimi', 'zhipu', 'deepseek', 'minimax', 'cindy', 'opencode_go']
