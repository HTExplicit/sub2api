<template>
  <AppLayout>
    <div class="space-y-6 pb-12">
      ...
      <section
        class="card sticky top-0 z-20 !rounded-none !border-0 p-0 shadow-outline ring-1 ring-gray-900/5 dark:!bg-dark-800 dark:ring-dark-700 supports-[backdrop-filter]:bg-white dark:supports-[backdrop-filter]:bg-dark-800"
      >
