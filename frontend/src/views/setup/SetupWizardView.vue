  ...
  >
    <div class="w-full max-w-2xl">
      ...
      <div class="mb-8 text-center">
        <div
          class="mb-4 inline-flex h-16 w-16 items-center justify-center rounded-none bg-primary-500 shadow-outline"
        >
      ...
      <!-- Step Content -->
      <div class="rounded-none bg-white p-8 shadow-outline dark:bg-dark-800">
        <!-- Step 1: Database -->
        <div v-if="currentStep === 0" class="space-y-6">
          ...
          <div class="flex items-center justify-between rounded-none border border-gray-200 p-3 dark:border-dark-700">
            <div>
        ...
        <div
          v-if="errorMessage"
          class="mt-6 rounded-none border border-red-200 bg-red-50 p-4 dark:border-red-800/50 dark:bg-red-900/20"
        >
        ...
        <div
          v-if="installSuccess"
          class="mt-6 rounded-none border border-green-200 bg-green-50 p-4 dark:border-green-800/50 dark:bg-green-900/20"
        >
          <div class="flex items-start gap-3">
            <svg
              v-if="!serviceReady"
