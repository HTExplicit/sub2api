...
go -C backend test -p=1 -tags unit ./internal/service ./internal/handler -run 'Test(Agent|ForwardResponses_.*(Chat|Reasoning)|ForwardAsAnthropic_ForceChatCompletions|.*NoAccount|.*SelectionFailure)' -count=1
