...
const (
	// Label holds the string label denoting the systemprompttemplate type in the database.
	...
	// Table holds the table name of the systemprompttemplate in the database.
	Table = "system_prompt_templates"
	// VersionsTable is the table that holds the versions relation/edge.
	VersionsTable = "system_prompt_template_versions"
	// VersionsInverseTable is the table name for the SystemPromptTemplateVersion entity.
	// It exists in this package in order to avoid circular dependency with the "systemprompttemplateversion" package.
	VersionsInverseTable = "system_prompt_template_versions"
	// VersionsColumn is the table column denoting the versions relation/edge.
	VersionsColumn = "template_id"
)

// Columns holds all SQL columns for systemprompttemplate fields.
var Columns = []string{
	FieldID,
	FieldCreatedAt,
	FieldUpdatedAt,
