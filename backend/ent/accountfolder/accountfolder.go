...
const (
	// Label holds the string label denoting the accountfolder type in the database.
	Label = "account_folder"
	...
	// Table holds the table name of the accountfolder in the database.
	...
	AccountsColumn = "management_folder_id"
)

// Columns holds all SQL columns for accountfolder fields.
var Columns = []string{
	FieldID,
	FieldCreatedAt,
	FieldUpdatedAt,
...
// OrderOption defines the ordering options for the AccountFolder queries.
