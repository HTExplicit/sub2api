...
func TestWSPassthroughUsageMeta_InitFromFirstFrame_PreservesExplicitMax(t *testing.T) {
	...
	require.Equal(t, "max", *got, "usage metadata preserves the actual outbound effort")
