...
func contributionRequiredCapabilities(contribution *extensionv1.Contribution) []string {
	...
	if (contribution.Action != "" || contribution.ResourceAction != nil || contribution.Slot == extensionv1.AccountViewSlot || contribution.Slot == extensionv1.AccountCreateSlot) && contribution.Permission == "admin" {
