...
func (m *Module) harvest(ctx, epoch context.Context, host HostCaller, cfg Config, req Operation, manual bool) (Outcome, error) {
	if !cfg.Enabled {
...
func hasRoutingDemand(ctx context.Context, host HostCaller, id int64, model string) bool {
	var record extensionv1.StateResult
...
func (m *Module) recordRoutingDemand(ctx context.Context, host HostCaller, cfg Config, request extensionv1.CodexRoutingDemand) (any, error) {
...
func observeRoutingResponse(ctx context.Context, host HostCaller, req extensionv1.CodexRoutingResponse) (any, error) {
