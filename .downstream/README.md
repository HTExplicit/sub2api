...
is labeled `upstream-review-required`; an authorized maintainer records the
completed review with `upstream-reviewed`. Text conflicts stop before a branch is pushed and
